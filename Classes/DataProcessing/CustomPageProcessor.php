<?php
namespace IDS\VeridatSitePackage\DataProcessing;
 ...
 */
class CustomPageProcessor implements DataProcessorInterface
{
...
//        $this->fileRepository = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Resource\FileRepository::class);
        ...
        $pages = $this->pageRepository->getMenu($uid, '*', 'sorting', 'AND hidden=0 AND nav_hide=0', true);
        $additionalData['subpages'] = $pages;
